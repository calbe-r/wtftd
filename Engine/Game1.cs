...
namespace wtftd.Engine
{
    ...
    public class Game1 : Game
    {
        ...
        private void SwitchGameState(BaseGameState gameState)
        {
            ...
            _currentGameState.Initialize(graphics.GraphicsDevice, graphics.GraphicsDevice.Viewport.Width, graphics.GraphicsDevice.Viewport.Height);
